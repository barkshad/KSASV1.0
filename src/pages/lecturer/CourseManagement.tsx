      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-lg">
        ...
        <div className="lg:col-span-12 mt-md">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-md">
              ...
              <div className="bg-surface-container-lowest p-md rounded-xl border border-outline-variant/30 hover:-translate-y-1 transition-all cursor-pointer shadow-sm">
                 <div className="flex justify-between items-start mb-base">
                    <div className="w-10 h-10 bg-secondary-container text-primary rounded-lg flex items-center justify-center">
                       <Code className="w-5 h-5" />
                    </div>
                    <span className="font-label-md text-error bg-error-container/20 px-2 py-0.5 rounded text-[10px]">LATE MARKING</span>
                 </div>
                 <h4 className="font-title-lg text-primary leading-tight">CSC 101</h4>
                 <p className="font-body-sm text-on-surface-variant mb-md">Introduction to Computer Science</p>
                 <div className="flex items-center justify-between text-sm py-2 border-t border-surface-container">
                    <div className="flex items-center gap-1 text-on-surface-variant">
                      <Users className="w-4 h-4" />
                      <span className="font-body-sm">210 Students</span>
                    </div>
                    <div className="flex items-center gap-1 text-tertiary-container">
                      <TrendingUp className="w-4 h-4" />
                      <span className="font-body-sm font-medium">94% Att.</span>
                    </div>
                 </div>
                 <button onClick={() => navigate('/lecturer/live')} className="w-full mt-md bg-surface-container text-primary font-bold py-2 rounded-lg hover:bg-secondary-container transition-colors">Start Session</button>
              </div>
