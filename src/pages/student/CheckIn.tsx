...
import { QrCode, CheckCircle, Loader2, School } from 'lucide-react';
    ...
    <div className="flex-grow flex items-center justify-center p-md md:p-gutter max-w-7xl mx-auto w-full min-h-[80vh] animate-in fade-in zoom-in-95 duration-500">
      <div className="w-full max-w-[448px] bg-surface-container-lowest rounded-xl shadow-lg border border-surface-variant p-6 flex flex-col items-center relative overflow-hidden">
        ...
        <div className="text-center mb-6">
          <h2 className="font-title-lg text-primary mb-2">Attendance Check-In</h2>
        ...
        {user && (
          <div className="w-full bg-primary-container/20 rounded-lg px-4 py-2 mb-4 flex items-center gap-2 text-sm">
            <School className="w-4 h-4 text-primary shrink-0" />
            <span className="text-on-surface font-medium truncate">
              Checking in as: <strong>{user.name}</strong> ({user.uid})
            </span>
          </div>
        )}
          ...
          <>
            {!showScanner ? (
              <div
                ...
                className="w-full aspect-square max-w-[280px] bg-surface-container rounded-lg border-2 border-dashed border-outline relative flex items-center justify-center mb-8 cursor-pointer overflow-hidden group hover:border-primary transition-colors"
              >
              ...
              <div className="w-full aspect-square max-w-[280px] rounded-lg overflow-hidden relative mb-8 border-2 border-primary">
                <Scanner
                  onScan={(result) => {
        ...
        {scanned && (
          <div className="absolute inset-0 bg-surface-container-lowest flex flex-col items-center justify-center p-6 text-center z-50 animate-in fade-in zoom-in duration-300">
            ...
            <h3 className="font-title-lg text-tertiary-container mb-2">Attendance Confirmed!</h3>
            {checkedInSession && (
